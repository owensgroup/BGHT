...
\hline
\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{\href{https://github.com/owensgroup/BGHT/tree/main/test}{\texttt{ Examples/\+Tests}}}} }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{\href{https://github.com/owensgroup/BGHT/tree/main/benchmarks}{\texttt{ Benchmarks}}}} }&\cellcolor{\tableheadbgcolor}\textbf{ {\bfseries{\href{https://github.com/owensgroup/BGHT/blob/main/results.md}{\texttt{ Results}}}} }\\\cline{1-3}
\endfirsthead
\hline
\endfoot
\hline
...
\DoxyCodeLine{  query.second = talbe.find(query.first, tile);}
\DoxyCodeLine{\}}
\DoxyCodeLine{int main()\{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{@article\{Awad:2021:BGH,}
\DoxyCodeLine{  title = \{Better \{GPU\} Hash Tables\},}
...
\DoxyCodeLine{  primaryclass = \{cs.DS\},}
\DoxyCodeLine{  journal = \{CoRR\},}
\DoxyCodeLine{  volume = \{abs/2108.07232\},}
\DoxyCodeLine{  archiveprefix = \{arXiv\},}
\DoxyCodeLine{  number = \{2108.07232\},}
\DoxyCodeLine{  eprint = \{2108.07232\},}
\DoxyCodeLine{  nonrefereed = \{true\},}
