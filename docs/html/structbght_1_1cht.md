...
members](structbght_1_1cht-members.html)
:::
...
[More\...](structbght_1_1cht.html#details)
...
+-----------------------------------+-----------------------------------+
|                                   | [c                                |
|                                   | ht](structbght_1_1cht.html#aeba94 |
...
|                                   | [Mo                               |
|                                   | re\...](structbght_1_1cht.html#ae |
|                                   | ba94f76492153267d6c2a8f0de331b5)\ |
+-----------------------------------+-----------------------------------+
|                                   |                                   |
+-----------------------------------+-----------------------------------+
| []{#a                             | **cht** (const                    |
| b8475ae4c11257ff5476e6a5329a7af8} | [                                 |
|                                   | cht](structbght_1_1cht.html){.el} |
|                                   | &other)                           |
+-----------------------------------+-----------------------------------+
...
+-----------------------------------+-----------------------------------+
| []{#a                             | **cht**                           |
| 87299241de2004dfe0bc7662401d5ea1} | ([                                |
|                                   | cht](structbght_1_1cht.html){.el} |
|                                   | &&)=delete                        |
+-----------------------------------+-----------------------------------+
...
+-----------------------------------+-----------------------------------+
| []{#a                             | **operator=** (const              |
| 090f8a449a06b62f43057d7a3fddea99} | [                                 |
| [                                 | cht](structbght_1_1cht.html){.el} |
| cht](structbght_1_1cht.html){.el} | &)=delete                         |
| &                                 |                                   |
+-----------------------------------+-----------------------------------+
...
+-----------------------------------+-----------------------------------+
| []{#a                             | **operator=**                     |
| d62008d5e9b37455c84620b908b88bdf} | ([                                |
| [                                 | cht](structbght_1_1cht.html){.el} |
| cht](structbght_1_1cht.html){.el} | &&)=delete                        |
| &                                 |                                   |
+-----------------------------------+-----------------------------------+
...
+-----------------------------------+-----------------------------------+
| bool                              | [inse                             |
|                                   | rt](structbght_1_1cht.html#a33b47 |
...
+-----------------------------------+-----------------------------------+
| void                              | [fi                               |
|                                   | nd](structbght_1_1cht.html#a81fdd |
...
|                                   | argument iterators.               |
|                                   | [Mo                               |
|                                   | re\...](structbght_1_1cht.html#a8 |
|                                   | 1fdda2b20c3dc2fd2c237e1e8c9ccac)\ |
+-----------------------------------+-----------------------------------+
|                                   |                                   |
+-----------------------------------+-----------------------------------+
| \_\_device\_\_ bool               | [inse                             |
|                                   | rt](structbght_1_1cht.html#a8a868 |
...
|                                   | nd](structbght_1_1cht.html#a6f45a |
...
|                                   | ns](structbght_1_1cht.html#a9e7ca |
...
+-----------------------------------+-----------------------------------+
| []{#a                             |                                   |
| f20eb7d8c81a2e50b531d0c1a50f3d1c} |                                   |
| template\<typename InputIt ,      |                                   |
| typename HashMap \>               |                                   |
+-----------------------------------+-----------------------------------+
| \_\_global\_\_ void               | *                                 |
|                                   | *detail::kernels::insert_kernel** |
|                                   | (InputIt, InputIt, HashMap)       |
+-----------------------------------+-----------------------------------+
|                                   |                                   |
+-----------------------------------+-----------------------------------+
| []{#a                             |                                   |
| 73ce454d0ad2bbed0e380303410ecb03} |                                   |
| template\<typename InputIt ,      |                                   |
| typename OutputIt , typename      |                                   |
| HashMap \>                        |                                   |
+-----------------------------------+-----------------------------------+
| \_\_global\_\_ void               | **detail::kernels::find_kernel**  |
...
:::
  ...
  ---------------------------------------------------------------------------------------------------------------------------- --- -------------------- ------------------------------
  [bght::cht](structbght_1_1cht.html){.el}\< Key, T, Hash, KeyEqual, Scope, Allocator \>::[cht](structbght_1_1cht.html){.el}   (   std::size_t          *capacity*,
                                                                                                                                   Key                  *sentinel_key*,
                                                                                                                                   T                    *sentinel_value*,
...
:::
  ...
  --------------------------------------------------------------------------------------------------- --- --------------- -----------------
  void [bght::cht](structbght_1_1cht.html){.el}\< Key, T, Hash, KeyEqual, Scope, Allocator \>::find   (   InputIt         *first*,
                                                                                                          InputIt         *last*,
                                                                                                          OutputIt        *output_begin*,
                                                                                                          cudaStream_t    *stream* = `0` 
                                                                                                      )                   
...
:::
  ...
  ------------------------------------------------------------------------------------------------------------------------- --- ------------------- ------- --- --
  \_\_device\_\_ mapped_type [bght::cht](structbght_1_1cht.html){.el}\< Key, T, Hash, KeyEqual, Scope, Allocator \>::find   (   key_type const &    *key*   )   
  ------------------------------------------------------------------------------------------------------------------------- --- ------------------- ------- --- --
:::
...
:::
  ...
  ----------------------------------------------------------------------------------------------------- --- --------------- -----------------
  bool [bght::cht](structbght_1_1cht.html){.el}\< Key, T, Hash, KeyEqual, Scope, Allocator \>::insert   (   InputIt         *first*,
                                                                                                            InputIt         *last*,
                                                                                                            cudaStream_t    *stream* = `0` 
                                                                                                        )                   
  ----------------------------------------------------------------------------------------------------- --- --------------- -----------------
...
:::
  ...
  -------------------------------------------------------------------------------------------------------------------- --- --------------------- -------- --- --
  \_\_device\_\_ bool [bght::cht](structbght_1_1cht.html){.el}\< Key, T, Hash, KeyEqual, Scope, Allocator \>::insert   (   value_type const &    *pair*   )   
  -------------------------------------------------------------------------------------------------------------------- --- --------------------- -------- --- --
:::
...
:::
  ...
  ----------------------------------------------------------------------------------------------------------------------- --- -------- ------- --- --
  void [bght::cht](structbght_1_1cht.html){.el}\< Key, T, Hash, KeyEqual, Scope, Allocator \>::randomize_hash_functions   (   RNG &    *rng*   )   
  ----------------------------------------------------------------------------------------------------------------------- --- -------- ------- --- --
:::
...
-   include/[cht.hpp](cht_8hpp_source.html){.el}
:::
