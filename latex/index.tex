...
\href{https://owensgroup.github.io/BGHT/}{\texttt{ {\bfseries{Better GPU Hash Tables}}}} \href{https://arxiv.org/abs/2108.07232}{\texttt{ \mbox{[}ar\+Xiv\mbox{]}}} \href{https://escholarship.org/uc/item/6cb1q6rz}{\texttt{ \mbox{[}APOCS\mbox{]}}}~\newline
 {\itshape \href{https://maawad.github.io/}{\texttt{ Muhammad A. Awad}}, \href{https://scholar.google.com/citations?user=Z4_ZfiEAAAAJ&hl=en}{\texttt{ Saman Ashkiani}}, \href{https://web.cs.ucdavis.edu/~porumbes/}{\texttt{ Serban D. Porumbescu}}, \href{https://people.cs.rutgers.edu/~farach/}{\texttt{ Martín Farach-\/\+Colton}}, and \href{https://www.ece.ucdavis.edu/~jowens/}{\texttt{ John D. Owens}}}\hypertarget{index_autotoc_md1}{}\doxysection{Key features}\label{index_autotoc_md1}
...
\begin{quote}
\mbox{[}!\+NOTE\mbox{]} ~\newline
 An experimental HIP-\/based version of the library targeting AMD GPUs is available at the \href{https://github.com/owensgroup/BGHT/tree/hip}{\texttt{ hip}} branch (See the \href{https://github.com/owensgroup/BGHT/tree/hip/figs/Radeon-RX-7900-XT}{\texttt{ Radeon-\/\+RX-\/7900-\/\+XT}} results). \end{quote}
\hypertarget{index_autotoc_md2}{}\doxysection{How to use}\label{index_autotoc_md2}
BGHT is a header-\/only library. To use the library, you can add it as a submodule or use \href{https://github.com/cpm-cmake/CPM.cmake}{\texttt{ CMake Package Manager (CPM)}} to fetch the library into your CMake-\/based project (\href{https://github.com/owensgroup/BGHT/tree/main/examples/cpm}{\texttt{ complete example}}). 
\begin{DoxyCode}{0}
...
\DoxyCodeLine{\#include <bght/cht.hpp>}
...
\begin{DoxyItemize}
\item Currently hash tables based on cuckoo hashing do not support concurrent insertion and queries. IHT and P2\+BHT support concurrent insertions and queries. For hash tables that use a probing scheme other than IHT\+:
...
Please check our \href{https://arxiv.org/abs/2108.07232}{\texttt{ paper}} for comprehensive analysis and benchmarks. Also, see the following steps to reproduce the results.\hypertarget{index_autotoc_md13}{}\doxysection{Questions and bug report}\label{index_autotoc_md13}
...
\DoxyCodeLine{                  Porumbescu and Mart\{\(\backslash\)'\{i\}\}n Farach-\/Colton and John D.}
\DoxyCodeLine{                  Owens\},}
...
\DoxyCodeLine{  pages         = \{33-\/-\/50\},}
\DoxyCodeLine{  code          = \{https://github.com/owensgroup/BGHT\},}
\DoxyCodeLine{  doi           = \{10.1137/1.9781611977578.ch3\},}
