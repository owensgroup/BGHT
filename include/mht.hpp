...
/**
 * @brief MHT mht (bucketed cuckoo hash table) is an associative static GPU hash table
...
struct mht {
  ...
  mht(mht&&) = delete;
  /**
   * @brief The assignment operator for the mht is currently deleted
   */
  mht& operator=(const mht&) = delete;
  /**
   * @brief The move assignment operator for the mht is currently deleted
   */
  mht& operator=(mht&&) = delete;
  /**
 ...
 private:
  ...
  static constexpr int num_hfs_ = 50;
  Hash hfs_[num_hfs_];
...
using mht8 = typename bght::mht<Key,
                                  T,
...
template <typename Key, typename T>
using mht16 = typename bght::mht<Key,
                                   T,
                                   bght::universal_hash<Key>,
                                   bght::equal_to<Key>,
                                   cuda::thread_scope_device,
...
template <typename Key, typename T>
using mht32 = typename bght::mht<Key,
                                   T,
                                   bght::universal_hash<Key>,
                                   bght::equal_to<Key>,
                                   cuda::thread_scope_device,
