...
int main() {
	...
	for (int device = 0; device < count; ++device) {
		...
		bool is_unique = true;
		if (cudaSuccess == hipGetDeviceProperties(&prop, device)) {
			for (int device_1 = device - 1; device_1 >= 0; --device_1) {
				hipDeviceProp_t prop_1;
				if (cudaSuccess == hipGetDeviceProperties(&prop_1, device_1)) {
					if (prop.major == prop_1.major && prop.minor == prop_1.minor) {
						is_unique = false;
						break;
					}
				}
				else { printf("AutoDetectCudaArch: hipGetDeviceProperties failed.\n");return -1; }
			}
			if (is_unique) {
