...
void bench_bcht(std::vector<key_type>& keys,
  ...
  {
    auto bcht_32_result =
        bench_insert_find<bght::bchtWarpSize<key_type, value_type>>(d_keys,
                                                                    d_pairs,
                                                                    d_find_keys,
                                                                    d_find_results,
                                                                    find_keys,
...
void bench_iht(std::vector<key_type>& keys,
  ...
  {
    auto iht_32_result =
        bench_insert_find<bght::ihtWarpSize<key_type, value_type, 6>>(d_keys,
                                                                      d_pairs,
                                                                      d_find_keys,
                                                                      d_find_results,
                                                                      find_keys,
  ...
  {
    auto iht_32_result =
        bench_insert_find<bght::ihtWarpSize<key_type, value_type, 12>>(d_keys,
                                                                       d_pairs,
                                                                       d_find_keys,
                                                                       d_find_results,
                                                                       find_keys,
  ...
  {
    auto iht_32_result =
        bench_insert_find<bght::ihtWarpSize<key_type, value_type, 19>>(d_keys,
                                                                       d_pairs,
                                                                       d_find_keys,
                                                                       d_find_results,
                                                                       find_keys,
  ...
  {
    auto iht_32_result =
        bench_insert_find<bght::ihtWarpSize<key_type, value_type, 25>>(d_keys,
                                                                       d_pairs,
                                                                       d_find_keys,
                                                                       d_find_results,
                                                                       find_keys,
...
void bench_p2bht(std::vector<key_type>& keys,
  ...
  // 32
  {
    auto p2cht_32_result =
        bench_insert_find<bght::p2bhtWarpSize<key_type, value_type>>(d_keys,
                                                                     d_pairs,
                                                                     d_find_keys,
                                                                     d_find_results,
                                                                     find_keys,
